...
dependencies {
   ...
   implementation 'org.apache.grails.plugins:spring-security-cas:{projectVersion}'
   ...
----
...
dependencies {
   ...
   implementation 'org.apache.grails.plugins:spring-security-cas:{threeZeroXProjectVersion}'
   ...
----
