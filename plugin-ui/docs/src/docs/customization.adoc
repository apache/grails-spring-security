...
[source,javascript]
----
//= require webjars/jquery-ui/${grails.plugin.springsecurity.ui.Constants.JQUERY_UI_VERSION}/ui/minified/jquery-ui.min.js
----
...
----
/*
 *= require webjars/jquery-ui/${grails.plugin.springsecurity.ui.Constants.JQUERY_UI_VERSION}/themes/smoothness/jquery-ui.min.js
 */
----
